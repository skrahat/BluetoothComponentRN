...
const App = () => {
  ...
  const renderItem = (item) => {
    const color = item.connected ? 'green' : '#f0e6e6';
    return (
  ...
  return (
    <>
      ...
      <SafeAreaView>
        <View style={{  backgroundColor: "#693D3D", flexDirection: 'row', justifyContent: 'space-evenly'}}>
            ...
            <Text style={{margin:10, fontSize: 30 , fontWeight: 'bold', color: '#bdd6fc',}}>
        ...
        <ScrollView
          ...
          <View style={styles.body}>
            ...
            <View style={{margin: 20,flex: 1, flexDirection: 'row', justifyContent: 'space-evenly'}}>
              <Button 
                color="#C38370"
                title={'Start Scan (' + (isScanning ? 'on' : 'off') + ')'}
                onPress={() => startScan() } 
              />  
              <Button color="#C38370" title="Connected Devices" onPress={() => retrieveConnected() } />          
            </View>
          ...
          <View
              style={{
                borderTopColor: "#693D3D",
                borderTopWidth: 2,
                borderBottomColor: "#693D3D",
                borderBottomWidth: 2,
              }}>
                <Text style={{textAlign: 'center', backgroundColor: '#F4CBC6',}}> Devices</Text>
